        ...
        protected void Unnamed1_Click(object sender, EventArgs e)
        {
            if (txtcuenta.Text != "")
            {
                try
                {
                    ...
                    MySqlConnection conexion = new MySqlConnection("Server=127.0.0.1; database=posada; Uid=root; pwd=;");
                    ...
                    string nombre = "CanCat";

                    var fromAddress = new MailAddress("cancatvetpet@gmail.com", "CanCat");
                    const string fromPassword = "Petcare777";
                    ...
                    alertas.Text = "<script>Swal.fire('Correo enviado con éxito', 'Contraseña recuperada', 'success');</script>";
                }
                catch
                {
