<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pricing.aspx.cs" Inherits="CanCat_.pricing" %>
...
<body>
            ...
            <div class="row">
                <div class="col-md-6 d-flex align-items-center">
                    <p class="mb-0 phone pl-md-2">
                        ...
                        <a href="#"><span class="fa fa-paper-plane mr-2"></span>iniciar sesion</a>
                    </p>
                </div>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        <div class="container">
            <a class="navbar-brand" href="index.html"><span class="flaticon-pawprint-1 mr-2"></span>CanCat!</a>
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav ml-auto">
                   <li class="nav-item"><a href="index.aspx" class="nav-link">Inicio</a></li>
                    ...
                    <li class="nav-item"><a href="contact.aspx" class="nav-link">Tienda</a></li>
                </ul>
            </div>
        </div>
    </nav>
        ...
        <div class="container">
            <div class="row no-gutters slider-text align-items-end">
                <div class="col-md-9 ftco-animate pb-5">
                    <p class="breadcrumbs mb-2"><span class="mr-2"><a href="index.html">Inicio <i class="ion-ios-arrow-forward"></i></a></span> <span>Precios <i class="ion-ios-arrow-forward"></i></span></p>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-3 pl-lg-5 mb-4 mb-md-0">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="pricing.aspx" class="py-2 d-block">Paquetes</a></li>
                        <li><a href="blog.aspx" class="py-2 d-block">Blog</a></li>
