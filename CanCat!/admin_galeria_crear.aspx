<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_galeria_crear.aspx.cs" Inherits="CanCat_.admin_galeria_crear" %>
            ...
            <div class="row">
                <div class="col-sm-6  m-auto">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title ">Agregar Imagenes</h5>
                            ...
                            <div class="myform-bottom">
                                ...
                                <div class="mb-3">
                                    <asp:Label ID="LabelImagen" CssClass="form-label" runat="server" Text="Imagen" Font-Bold="True"></asp:Label>
                                    <asp:FileUpload ID="PhotoFile" CssClass="form-control" runat="server" />
                                </div>
                                <div class="pt-2">
                                    <asp:Button ID="btnSeleccionar" runat="server" Text="crear" CssClass="btn btn-primary" Width="30%" OnClick="seleccionar_click"  ></asp:Button>
                                </div>
